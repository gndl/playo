...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0c85532d87b1ad60c9dfa05dea4d3330) *)
(*
...
let setup_t =
  {
          ...
          conf_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("opam", ["install"; "lablgtk"; "config-file"])))
                 ];
     ...
     oasis_digest =
       Some "-\167\238\134:\006\001\130\241i\172\003\182I\153\208";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
