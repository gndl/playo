...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4e2d7a22decd031928d5fc9ac9b49ab1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Ga\235tan Dubreil"];
          homepage = None;
          synopsis = "A simple audio player in OCaml";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lablgtk2.glade", None);
                           FindlibPackage ("sndfile", None);
                           FindlibPackage ("taglib", None);
                           FindlibPackage ("portaudio", None);
                   ...
                   {exec_custom = false; exec_main_is = "playo.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/gndl/playo.git";
                      src_repo_browser = Some "https://github.com/gndl/playo";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\247\026\148\201\026pG\019J\237g\247\014\133\031\n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
